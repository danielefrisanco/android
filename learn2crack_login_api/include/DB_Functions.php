...
(!preg_match('/^(\\\\.|[A-Za-z0-9!#%&`_=\\/$\'*+?^{}|~.-])+$/',
 ...
 /**
    ...
    public function checkhashSSHA($salt, $password) {
     ...
     public function insertSpam($msg,$uid) {
		 
     //store a message
		  
        $result = mysql_query("INSERT INTO messages( uid ,   created, testo) VALUES ($uid,NOW(),$msg)");
        // check for successful store
        if ($result) {
            // get message  details 
            $mid = mysql_insert_id(); // last inserted mid
...
//     * returns name and types of fields
//     */
//
